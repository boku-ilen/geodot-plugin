...
void Geodot::_register_methods() {
    ...
    register_method("get_raster_layer_for_pyramid",
...
Ref<GeoRasterLayer> Geodot::get_raster_layer_for_pyramid(String root_folder,
                                                         String image_ending) {
    Ref<PyramidGeoRasterLayer> layer =
        Ref<PyramidGeoRasterLayer>(PyramidGeoRasterLayer::_new());
